...
CREATE_ACTION_1ARG(log_bno_update, SD_Shield* logger)
...
CREATE_ACTION_1ARG(log_altitude_update, SD_Shield* logger)
...
CREATE_ACTION_1ARG(log_ext_temp, SD_Shield* logger)
