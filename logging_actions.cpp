...
EXECUTE_ACTION(log_all_data)
{
	...
	_logfile.print(F(", "));
	_logfile.print(data->UltraViolet);
	_logfile.print(F(", "));
	_logfile.print(data->UltraVioletVoltage);
	_logfile.print(F(", "));
	_logfile.print(data->UVindex);
	_logfile.println();
	_logfile.close();
}
